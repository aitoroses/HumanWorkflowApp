...
public class TaskPredicateQueryType {
    ...
    protected DisplayColumnType displayColumnList = new DisplayColumnType();
    protected TaskOptionalInfoType optionalInfoList = new TaskOptionalInfoType();
    @XmlElement(required = true)
    protected TaskPredicateType predicate = new TaskPredicateType();
    protected TaskOrderingType ordering = new TaskOrderingType();
    @XmlAttribute
